...
void
hashTypeCurrentFromZiplist(hashTypeIterator *hi, int what, unsigned char **vstr, unsigned int *vlen, long long *vll);
...
unsigned int getKeysInSlot(unsigned int hashslot, cobj **keys, unsigned int count);
...
int *getKeysFromCommand(struct cacheCommand *cmd, cobj **argv, int argc, int *numkeys);

void getkeysFreeResult(int *result);

int *zunionInterGetKeys(struct cacheCommand *cmd, cobj **argv, int argc, int *numkeys);
...
int getTimeoutFromObjectOrReply(cacheClient *c, cobj *object, ms_time_t *timeout,
                                int unit);
...
void _cacheAssertWithInfo(cacheClient *c, cobj *o, char *estr, char *file, int line);
